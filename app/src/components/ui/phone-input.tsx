...
const PhoneInput: React.ForwardRefExoticComponent<PhoneInputProps> = React.forwardRef<React.ElementRef<typeof RPNInput.default>, PhoneInputProps>(({ className, onChange, value, ...props }, ref) => {
  return (
    <RPNInput.default
      ref={ref}
        ...
        <Command>
          ...
          <CommandList>
            <ScrollArea ref={scrollAreaRef} className="h-72">
              ...
              <CommandGroup>{countryList.map(({ value, label }) => (value ? <CountrySelectOption key={value} country={value} countryName={label} selectedCountry={selectedCountry} onChange={onChange} onSelectComplete={() => setIsOpen(false)} /> : null))}</CommandGroup>
            </ScrollArea>
          </CommandList>
        </Command>
      </PopoverContent>
